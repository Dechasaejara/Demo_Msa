        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerAvator = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FoodItemId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FoodItemName = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    FoodMainImgName = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodItemId1 = table.Column<long>(type: "INTEGER", nullable: true),
